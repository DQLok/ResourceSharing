...
public class AdminServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int index = 1;
            String query_admin = " AND r.statusreqID <> 'sr4' ";
            int count = dao.countRequest(query_admin, "", "", "");
            int endpage = count / PAGESIZE;
            if (count % PAGESIZE != 0) {
                endpage++;
            }
            List<RequestDTO> list = dao.getListRequest(query_admin, "", "", "", index, PAGESIZE);
            ...
            log("Error AdminServlet " + e.getStackTrace());
        } finally {
